...
void find_cmd(shell_info_t *);
void fork_cmd(shell_info_t *);

/* toem_parser.c */
int is_cmd(shell_info_t *, char *);
...
char *find_char_string(char *, char);
...
void print_shell_error(shell_info_t *, char *);
int print_integer(int, int);
char *convert_number_to_string(long int, int, int);
void rm_com(char *);

/* toem_builtin.c */
int _myexit(shell_info_t *);
int _mycd(shell_info_t *);
int _myhelp(shell_info_t *);

/* toem_builtin1.c */
int _myhistory(shell_info_t *);
int _myalias(shell_info_t *);
...
int _myenv(shell_info_t *);
int _mysetenv(shell_info_t *);
int _myunsetenv(shell_info_t *);
int populate_env_list(shell_info_t *);

/* toem_getenv.c */
char **get_environ(shell_info_t *);
int unset_environment_variable(shell_info_t *, char *);
int set_environment_variable(shell_info_t *, char *, char *);

/* toem_history.c */
char *get_history_file(shell_info_t *info);
...
int renumber_history(shell_info_t *info);
...
int replace_alias(shell_info_t *);
